...
int led_callback(int argc, char *argv[], char argv2[])
{
    ...
    {
        float blink_freq = 1;
        if ((argc == 9) && sscanf(argv[2], "%f", &blink_freq) && sscanf(argv[3], "%d", &r1) && sscanf(argv[4], "%d", &g1) && sscanf(argv[5], "%d", &b1) && sscanf(argv[6], "%d", &r2) && sscanf(argv[7], "%d", &g2) && sscanf(argv[8], "%d", &b2))
        {
    ...
    {
        float breath_freq = 1;
        if ((argc == 6) && sscanf(argv[2], "%f", &breath_freq) && sscanf(argv[3], "%d", &r1) && sscanf(argv[4], "%d", &g1) && sscanf(argv[5], "%d", &b1))
        {
